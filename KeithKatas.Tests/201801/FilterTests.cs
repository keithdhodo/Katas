...
namespace KeithKatas.Tests.January2018
{
    ...
    {
        [Test]
        public void Filter_GetIntegersFromList_MixedValues_ShouldPass_1()
        {
            var list = new List<object>() { 1, 2, "a", "b" };
            var expected = new List<int>() { 1, 2 };
            var actual = Filter.GetIntegersFromList(list);
            Assert.IsTrue(expected.SequenceEqual(actual));
        }

        [Test]
        public void Filter_GetIntegersFromList_MixedValues_ShouldPass_2()
        {
        ...
        [Test]
        public void Filter_GetIntegersFromList_MixedValues_ShouldPass_3()
        {
        ...
        [Test]
        public void Filter_GetIntegersFromList_MixedValues_ShouldBeEmpty()
        {
        ...
        [Test]
        public void Filter_GetIntegersFromList_MixedValues_ShouldPass_5()
        {
            var list = new List<object>() { 1, 2, "a", "b" };
            var expected = new List<int>() { 1, 2 };
            var actual = Filter.GetIntegersFromList(list);
      ...
      "Hello!!!!", "!!!! World!", "Raw", "Danger", "Is", "The", "Best", "PS2", "Game", "Disaster", "Report", "Is", "Alright", "I", "Guess",
        ...
        public void Filter_GetIntegersFromList_RandomTest()
        {
            const int Tests = 100;
            ...
            for (int i = 0; i < Tests; ++i)
            {
                ...
                IEnumerable<int> actual = Filter.GetIntegersFromList(testCase);
